...
if ($Proof == "Aadhar Card") {
    echo '<a href="Adhaar/NAMAN LICENSE.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "License") {
    echo '<a href="License/NAMAN LICENSE.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "Voter Id") {

    echo '<a href="Voter/NAMAN LICENSE.pdf"><input type="submit" value="Download" /></a><br>';
}
if ($Proof == "Pan") {
    echo '<a href="Pan/NAMAN LICENSE.pdf"><input type="submit" value="Download" /></a><br>';
}
